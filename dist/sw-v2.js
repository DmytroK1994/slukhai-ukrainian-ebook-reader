const CACHE='slukhai-v56';
const CORE=['./','./index.html','./styles.css?v=56','./updates.css?v=56','./app.js?v=56','./config.js?v=56','./build-version.json?v=56','./manifest.webmanifest?v=56','./icon.svg?v=56','./vendor/epubjs/epub.min.js'];
