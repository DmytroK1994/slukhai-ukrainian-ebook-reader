const CACHE='slukhai-v50';
const CORE=['./','./index.html','./styles.css','./updates.css','./app.js','./config.js','./build-version.json','./manifest.webmanifest','./icon.svg','./vendor/epubjs/epub.min.js'];
